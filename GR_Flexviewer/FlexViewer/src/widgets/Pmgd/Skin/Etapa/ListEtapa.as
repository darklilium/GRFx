package widgets.Pmgd.Skin.Etapa
{
	...
	public class ListEtapa extends SkinnableComponent
	{
		...
		{	
			setStyle("skinClass",ListEtapaSkin);						
		}		
		...
		public static function queryPropEtapa():void{
			...
			{   
				Alert.show("Error en consulta propietarios y etapas","Carga de propietarios");
			}
		}
